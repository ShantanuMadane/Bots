/** This is a sample code for your bot**/
	  var gupshup={
	        welcomeMsg:"Hi, I am "+String.fromCodePoint(0x26A1)+"Railway Bot"+String.fromCodePoint(0x26A1)+". I will provide you all railway services.\n-Enter keyword \"help\" for more information.",
	        apiKey:"iuijc7579",
...
// 			],
	    ...
	    function MessageHandler(context, event) {
	        ...
	        context.simpledb.roomleveldata["state_"+event.sender]="";    
	        context.sendResponse(rowService);    
	        }    
	        else
	        {
           ...
           // var jsonObj=JSON.parse(gupshup.stateQues[0]);
	        ...
	        liveTrainStatus(trainNumber,newDate);
	        }
	        else
	        {
 ...
 //--------------------------------------All function start-----------------------------------------------------
	    ...
	    function liveTrainStatus(trainNumber,date) {

			/*create url for request*/
	    	var url=gupshup.baseUrl+"live/train/"+trainNumber+"/doj/"+date+"/apikey/"+gupshup.apiKey;
